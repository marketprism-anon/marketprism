...
// ProveBytes Coder: I changed this function first letter to uppercase so that I can use
...
// VerifyBytes Coder: I changed this function first letter to uppercase
