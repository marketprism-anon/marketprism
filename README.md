...
- in the case of debugging the following code in ([simul_test.go](https://github.com/marketprism-anon/marketprism/blob/shardedMarket/simulation/manage/simulation/simul_test.go)) indicates the debug logging level, with 0 being the least logging and 5 being the most (every tiny detail is logged in this level)
```
...
([ChainBoost.toml](https://github.com/marketprism-anon/marketprism/blob/shardedMarket/simulation/manage/simulation/ChainBoost.toml))
...
--------------------------------------------------------------------------------------------------
1. these modules from Dedis Lab are used with few modifications: [Onet](https://github.com/marketprism-anon/marketprism/tree/shardedMarket/onet) (including `Network`, `Overlay`, and `Log`) and `Simulation` (See: [Onet ReadMe File](https://github.com/dedis/onet/blob/shardedMarket/README.md))
...
3. This module from Algorand is used with some modifications: [VRF](https://github.com/marketprism-anon/marketprism/tree/shardedMarket/vrf) (See: [VRF ReadMe File](https://github.com/marketprism-anon/marketprism/blob/shardedMarket/vrf/ReadMe.MD))
4. Added modules for marketprism:
- [PoR](https://github.com/marketprism-anon/marketprism/tree/shardedMarket/por) (See: [PoR ReadMe File](https://github.com/marketprism-anon/marketprism/blob/shardedMarket/por/README.md))
- [MainandSideChain](https://github.com/marketprism-anon/marketprism/tree/shardedMarket/MainAndSideChain) including (See: [MainandSideChain ReadMe File](https://github.com/marketprism-anon/marketprism/blob/shardedMarket/MainAndSideChain/ReadMe.MD))
