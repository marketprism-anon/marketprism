...
func init() {
	...
	network.RegisterMessage(MainAndSideChain.LtRSideChainNewRoundChain5{})
	network.RegisterMessage(MainAndSideChain.RtLSideChainNewRoundChain5{})
...
func NewChainBoostProtocol(n *onet.TreeNodeInstance) (onet.ProtocolInstance, error) {
	...
	bz.SCRoundNumber["por3"] = atomic.NewInt64(1)
	...
	bz.CommitteeNodesTreeNodeID5 = make([]onet.TreeNodeID, bz.CommitteeWindow)
	...
	if err := n.RegisterChannel(&bz.RtLSideChainNewRoundChanChain5); err != nil {
		return bz, err
	}
	if err := n.RegisterChannel(&bz.LtRSideChainNewRoundChanChain5); err != nil {
		return bz, err
	}
	return bz, nil
}
