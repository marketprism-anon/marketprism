...
// func TestResearchlabab_parseHosts(t *testing.T) {
// 	d := &Researchlabab{}
// 	require.NotNil(t, d.parseHosts(""))
// 	require.NotNil(t, d.parseHosts(ResearchlabHostsErr1))
// 	require.NotNil(t, d.parseHosts(ResearchlabHostsErr2))

// 	log.ErrFatal(d.parseHosts(ResearchlabHosts1))
// 	require.Equal(t, 9, len(d.Virt))
// 	require.Equal(t, 9, len(d.Phys))

// 	log.ErrFatal(d.parseHosts(ResearchlabHosts2))
// 	require.Equal(t, 2, len(d.Virt))
// 	require.Equal(t, 2, len(d.Phys))
// }

const ResearchlabHostsErr1 = `
